...
async def lifespan(app: FastAPI):
    global scanner_task, application
...
async def run_polling():
    ...
    try:
        ...
        logger.info("Telegram бот запущен! Напиши /start боту в личку.")
...
async def root():
    return {
        "status": "ok", 
        "tracked": len(LOW_VOLUME_SYMBOLS),
...
async def get_symbols():
    return {
        ...
        "low_volume_symbols": list(LOW_VOLUME_SYMBOLS)
    }
